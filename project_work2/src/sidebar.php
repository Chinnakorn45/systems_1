...
<div class="offcanvas offcanvas-start sidebar-offcanvas" tabindex="-1" id="offcanvasSidebar" aria-labelledby="offcanvasSidebarLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="offcanvasSidebarLabel"><i class="fas fa-boxes me-2"></i> เมนู</h5>
  ...
  <div class="offcanvas-body d-flex flex-column p-3">
    <nav class="nav flex-column">
      ...
      <?php else: /* admin */ ?>
        ...
        <!-- NEW: โอนสิทธิครุภัณฑ์ (Admin only - Mobile) -->
        <a class="nav-link<?php if($current=='transfer_assets.php') echo ' active'; ?>" href="transfer_assets.php">
          <i class="fas fa-right-left me-2"></i> โอนสิทธิครุภัณฑ์
        </a>

        <a class="nav-link<?php if($current=='users.php') echo ' active'; ?>" href="users.php"><i class="fas fa-users me-2"></i> จัดการผู้ใช้</a>
        <a class="nav-link<?php if($current=='settings.php') echo ' active'; ?>" href="settings.php"><i class="fas fa-cog me-2"></i> ตั้งค่าระบบ</a>
        <a class="nav-link<?php if($current=='user_guide.php') echo ' active'; ?>" href="user_guide.php"><i class="fas fa-book-open me-2"></i> คู่มือการใช้งาน</a>
        <a class="nav-link<?php if($current=='profile.php') echo ' active'; ?>" href="profile.php"><i class="fas fa-user-edit me-2"></i> แก้ไขโปรไฟล์</a>
        <a class="nav-link text-danger" href="logout.php"><i class="fas fa-sign-out-alt me-2"></i> ออกจากระบบ</a>
      <?php endif; ?>
...
<div class="col-md-3 col-lg-2 px-0 d-none d-md-block">
  <div class="sidebar p-3 h-100 d-flex flex-column">
    <div class="text-center mb-4">
      <img src="img/logo1.png" alt="โลโก้1" class="logo-img">
      <img src="img/logo2.png" alt="โลโก้2" class="logo-img">
      <h4 class="mt-2"><i class="fas fa-boxes me-2"></i>ระบบบันทึกคลังครุภัณฑ์</h4>
    ...
    <nav class="nav flex-column flex-grow-1">
      ...
      <?php else: /* admin */ ?>
        ...
        <!-- NEW: โอนสิทธิครุภัณฑ์ (Admin only - Desktop) -->
        <a class="nav-link<?php if($current=='transfer_assets.php') echo ' active'; ?>" href="transfer_assets.php">
          <i class="fas fa-right-left me-2"></i> โอนสิทธิครุภัณฑ์
        </a>
