...
$success = false;
$is_admin_add = isset($_GET['admin']) && $_GET['admin'] == 1;
...
<head>
    ...
    <title>สมัครสมาชิก - ระบบบันทึกคลังครุภัณฑ์</title>
    ...
    <div class="register-container">
        ...
        <?php if ($success): ?>
            <div class="alert alert-success" role="alert">
                สมัครสมาชิกสำเร็จ! <a href="login.php" class="alert-link">เข้าสู่ระบบ</a>
            </div>
        <?php else: ?>
            ...
            <form action="register.php" method="post">
                ...
                <button type="submit" class="btn btn-primary btn-register"><?php echo $is_admin_add ? 'เพิ่มผู้ใช้' : 'สมัครสมาชิก'; ?></button>
            </form>
