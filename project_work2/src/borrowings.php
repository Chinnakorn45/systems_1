            ...
            <div class="main-content mt-4 mt-md-5">
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-0">
                        <!-- เลื่อนเฉพาะตาราง + thead sticky เหมือน users.php -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="alert alert-info">
          ...
          <ul class="mb-0 mt-2" id="missingFieldsList"></ul>
        </div>
      </div>
...
document.addEventListener('DOMContentLoaded', function() {
  // ตรวจข้อมูลผู้ใช้ก่อนเปิดหน้าเพิ่มการยืม
  window.checkUserProfile = function() {
    ...
    if (missingFields.length > 0) {
      ...
      document.getElementById('missingFieldsList').innerHTML = missingFields.map(f => `<li>${f}</li>`).join('');
      modal.show();
    } else {
        ...
        .then(html => {
          ...
          if (form) {
            form.addEventListener('submit', function(ev) {
              ...
              fetch('transfer_borrower.php?id=' + borrowId, { method: 'POST', body: formData })
                .then(res => res.text())
                .then(resp => {
