    ...
    <div class="col-md-9 col-lg-10 px-0">
      <div class="main-content mt-4 mt-md-5">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-2">
          <h2 class="mb-0"><i class="fas fa-dolly me-2"></i>การเบิกวัสดุ</h2>
          <div class="d-flex align-items-center gap-2">
            <input type="text" id="dispenseSearch" class="form-control" style="max-width:350px;" placeholder="ค้นหารายการเบิกวัสดุ...">
            <a href="dispensation_form.php" class="btn btn-add"><i class="fas fa-plus"></i> เพิ่มการเบิกวัสดุ</a>
          </div>
        </div>
              ...
              <table class="table table-bordered table-hover align-middle mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= thaidate('j M Y', $row['dispense_date']); ?></td>
                    <td><?= (int)$row['quantity_dispensed']; ?></td>
                    <td><?= htmlspecialchars($row['notes']); ?></td>
                    <td>
                      <a href="dispensation_form.php?id=<?= $row['dispense_id']; ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                      <a href="dispensations.php?action=delete&id=<?= $row['dispense_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('ยืนยันการลบ?');"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                  <?php endwhile; ?>
