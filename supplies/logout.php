...
if (isset($_SESSION['user_id']) && isset($_SESSION['full_name'])) {
    ...
    $log_stmt = mysqli_prepare($link, "INSERT INTO user_logs (user_id, username, event_type, event_detail, event_time) VALUES (?, ?, 'ออกจากระบบ', 'ออกจากระบบระบบจัดการอุปกรณ์สำนักงาน สำเร็จ', NOW())");
